            ...
            <div className="bg-white text-gray-500 w-96 max-w-96 max-sm:w-80 md:p-6 p-4 text-left text-sm rounded-xl shadow-[0px_0px_10px_0px] shadow-black/10">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="min-w-full my-3">
                        <input value={userData.username} name='username' onChange={handleChange}  id="username" className="w-full bg-transparent border border-gray-500/30 outline-none rounded-2xl mb-2 py-2.5 px-4" type="text" placeholder="Enter your name"/> 
