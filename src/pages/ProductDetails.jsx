      ...
      <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0">
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
          ...
          <div className="mt-6 sm:mt-8 lg:mt-0">
            ...
            {/* Title */}
            <p className="text-gray-500 mt-5">{product&& product.description}</p>

            {/* Sizes */}
            <div className="flex gap-3 mt-5">
              {product&& product.sizes.map((e,i)=>(
                <button key={i} className={`py-2 w-14 border-2 border-[var(--tertiary)] text-[var(--tertiary)] rounded-xl`}>{e}</button>
              ))}
            </div>
            {/* Buttons */}
            ...
            <p className="flex items-center mt-3"> <TbTruckDelivery className="text-[25px] mr-2"/> Free Delivery on orders over 500$</p>
