...
function NewArrivals({products}) {
    ...
    return (
        <section className="my-10 px-20 py-10">
        <h2 className=" w-fit  border-b-3 border-[var(--secondary)] mb-10 mx-auto pb-1">New Arrivals</h2>
        <div className="my-4 grid gap-8 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
            ...
            {products.slice(0,4).map((product)=>(
                ...
                <div>
                    <img src={product.image} alt="product" className="h-full w-full rounded"/>
                </div>
                <div className="pt-6">
