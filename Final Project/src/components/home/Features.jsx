...
function Features() {
    return (
        <section className="my-10 py-10 px-30 max-md:px-10">
            <h2 className="border-b-3 w-fit mx-auto pb-1 border-[var(--secondary)] mb-10">Our Features</h2>
            <div className="grid  md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-12 ">
                <div className="bg-white shadow-xl px-6 py-4 rounded-lg">
                <IoReturnUpBack className="text-4xl text-yellow-500" />
                <h3 class="mb-2 mt-1 text-xl font-bold  text-black dark:text-white">Easy Return</h3>
                ...
                <h3 class="mb-2 mt-1 text-xl font-bold text-black dark:text-white">Fast Delivery</h3>
                <p class="text-gray-500 dark:text-gray-400">
                ...
                <h3 class="mb-2 mt-1 text-xl font-bold dark:text-white text-black">
                    Secure Payment
                </h3>
                <p class="text-gray-500 dark:text-gray-400">
