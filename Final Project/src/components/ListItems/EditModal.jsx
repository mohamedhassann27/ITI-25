...
function EditModal({modal, setModal, product, setReload}) {
    ...
    {/* Main modal */}
    <div id="crud-modal" tabIndex={-1} aria-hidden="true" className={` ${modal? "fixed": "hidden"}  overflow-y-auto overflow-x-hidden fixed top-[20%] left-[40%]  z-50 justify-center items-center w-full max-h-full`}>
